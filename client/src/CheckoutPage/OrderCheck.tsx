...
export function OrderCheck() {
  ...
  function handleRemoteAreaChange(checked: boolean) {
    setOrder({ ...order!, isRemoteArea: checked, deliveryFee: checked ? 6000 : 3000 });
  }
  ...
  return (
    <div>
      ...
      <div>
        <h3>배송 정보</h3>
        <div>
          <Checkbox checked={order.isRemoteArea} onChange={handleRemoteAreaChange} />
